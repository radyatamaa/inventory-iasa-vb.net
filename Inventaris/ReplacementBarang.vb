...
Public Class ReplacementBarang
    ...
    Dim jenisBarangs As New List(Of Object)
    Dim listBarangMasukHandle2 As New List(Of Object)
    Dim listBarangKeluarFix2 As New List(Of Object)
    Dim listBarangKeluarFixHandle2 As New List(Of Object)
    ...
    Dim triggerTambahBarangKeluar2 As Boolean = False
    Dim isSelectedTipeJenis As Integer = 0
    Dim isSelectedTipeJenis2 As Integer = 0
    ...
    Function SimpanBarangKeluar(barangKeluar As Object, index As Integer)
        ...
        Try
            ...
            queryTblBarangKeluar = queryTblBarangKeluar + " " + barangKeluar.id_client.ToString + ",
                                    ...
                                    " + barangKeluar.id_barang_lama.ToString + ",
                                    '" + userlogin + "',
                                     CAST('" + DateTime.Now.ToString("s", DateTimeFormatInfo.InvariantInfo) + "'AS DATETIME),
                                    " + 1.ToString + "
                                    ); SELECT SCOPE_IDENTITY() "
            ...
            'update status barang lama
            UpdateStatusBarang(1, userlogin, barangKeluar.id_barang_lama)
        Catch ex As Exception
            MsgBox(ex.Message)
        Finally
            'GetBarangMasuk()
    ...
    Function MappingToDataGridBarangKeluar(result As List(Of Object))
        ...
        For Each insertDataBarangMasuk As Object In result
            ...
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(0).Value = insertDataBarangMasuk.nama_jenis
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(1).Value = insertDataBarangMasuk.nama_tipe
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(2).Value = insertDataBarangMasuk.serial_number
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(3).Value = insertDataBarangMasuk.nama_kondisi
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(4).Value = isTest
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(5).Value = insertDataBarangMasuk.nama_lokasi
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(6).Value = insertDataBarangMasuk.detail_lokasi
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(7).Value = insertDataBarangMasuk.catatan
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(8).Value = insertDataBarangMasuk.nama_status
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(9).Value = insertDataBarangMasuk.harga_akhir
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(10).Value = insertDataBarangMasuk.periode_rental
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(11).Value = insertDataBarangMasuk.rental_type
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(12).Value = insertDataBarangMasuk.rental_exp
            ...
            If index = 0 And isSelectedTipeJenis = 0 Then
                ...
                dt_barang_keluar.Columns(13).Visible = False
            End If
            dt_barang_keluar.Rows(dt_barang_keluar.RowCount - 2).Cells(13).Value = insertDataBarangMasuk.id_barang_keluar
    ...
    Function MappingToDataGridBarangKeluarFix(barangMasukHandle As Object)
        ...
        dt_barang_keluar_fix.Rows(dt_barang_keluar_fix.RowCount - 2).Cells(9).Value = barangMasukHandle.harga_akhir
        dt_barang_keluar_fix.Rows(dt_barang_keluar_fix.RowCount - 2).Cells(10).Value = barangMasukHandle.periode_rental
        dt_barang_keluar_fix.Rows(dt_barang_keluar_fix.RowCount - 2).Cells(11).Value = barangMasukHandle.rental_type
        dt_barang_keluar_fix.Rows(dt_barang_keluar_fix.RowCount - 2).Cells(12).Value = barangMasukHandle.rental_exp
        ...
        End If
        dt_barang_keluar_fix.Rows(dt_barang_keluar_fix.RowCount - 2).Cells(13).Value = barangMasukHandle.id_barang_keluar
    ...
    Function GetLastIdTransaksi() As List(Of Integer)
        ...
        Return result
    End Function
    Function GetBarangKeluarByStatusTipeAndJenis(idStatus As Integer, idJenis As Integer?, idTipe As Integer?, idClient As Integer, idToko As Integer)
        Dim result As New List(Of Object)
        ...
        Dim query As String = "SELECT * FROM tbl_barang_keluar bm
                                  ...
                                  WHERE 
                                    CAST(bm.garansi_exp AS DATE) >=  CAST('" + DateTime.Now.ToString("s", DateTimeFormatInfo.InvariantInfo) + "'AS DATE) AND    
                                    bm.is_active = 1 AND 
        ...
        While reader.Read
            ...
            .garansi_type = "",
            .garansi_exp = Nothing,
            .periode_rental = reader("garansi"),
            .rental_type = reader("garansi_type"),
            .rental_exp = reader("garansi_exp"),
    ...
    Function GetBarangMasukByStatusTipeAndJenis(idStatus As Integer, idJenis As Integer, idTipe As Integer, idToko As Integer)
        ...
        For Each insertDataBarangMasuk As Object In result
            ...
            If index = 0 And isSelectedTipeJenis2 = 0 Then
                isSelectedTipeJenis2 = 1
    ...
    End Function
    Private Sub ReplacementBarang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Dim listbarang2 As List(Of Object) = jenisBarangs
            If listbarang2.Count > 0 Then
                cmb_jenis_barang2.DataSource = listbarang2
                cmb_jenis_barang2.DisplayMember = "nama_jenis"
                cmb_jenis_barang2.ValueMember = "id_jenis"
            End If
            ...
            Dim listClient2 As List(Of Object) = clients
            If listClient2.Count > 0 Then
                cmb_client2.DataSource = listClient2
                cmb_client2.DisplayMember = "kd_client"
                cmb_client2.ValueMember = "id_client"
            End If
    ...
    Private Sub dt_barang_keluar_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dt_barang_keluar.CellClick
        ...
        For Each selectedItem As DataGridViewRow In selectedIdBarangMasuk
            ...
            Dim idBarangKeluar = selectedItem.Cells(13).Value
    ...
    Private Sub btn_tambah1_Click(sender As Object, e As EventArgs) Handles btn_tambah1.Click
    ...
    Private Sub btn_hapus1_Click(sender As Object, e As EventArgs) Handles btn_hapus1.Click
        Me.txt_harga_total.Text = 0
        Me.txt_harga_akhir.Text = 0
    ...
    Private Sub cmb_client_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_client.SelectedIndexChanged
        Try
            ...
            If client IsNot Nothing Then
                ...
                GetBarangKeluarByStatusTipeAndJenis(4, idJenis, idTipe, cmb_client.SelectedValue.id_client, UserInfo.IdToko)
            End If
        Catch ex As Exception
            ...
            If client IsNot Nothing Then
                ...
                Catch c As Exception
                    ...
                    End If
                End Try
                GetBarangKeluarByStatusTipeAndJenis(4, idJenis, idTipe, cmb_client.SelectedValue, UserInfo.IdToko)
            End If
        End Try
    End Sub
    ...
    Private Sub cmb_tipe_barang_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_tipe_barang.SelectedIndexChanged
        Try
            dt_barang_keluar.Rows.Clear()
            GetBarangKeluarByStatusTipeAndJenis(4, cmb_jenis_barang.SelectedValue, cmb_tipe_barang.SelectedValue.id_tipe, cmb_client.SelectedValue, UserInfo.IdToko)
        Catch ex As Exception
            dt_barang_keluar.Rows.Clear()
            GetBarangKeluarByStatusTipeAndJenis(4, cmb_jenis_barang.SelectedValue, cmb_tipe_barang.SelectedValue, cmb_client.SelectedValue, UserInfo.IdToko)
        End Try
    End Sub

    Private Sub cmb_jenis_barang2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_jenis_barang2.SelectedIndexChanged
        If cmb_jenis_barang2.SelectedIndex <> -1 Then
            Try
                Dim idJenisBarang = cmb_jenis_barang2.SelectedValue.id_jenis
            Catch ex As Exception
                Dim idJenisBarang = cmb_jenis_barang2.SelectedValue
                Dim listTipe As List(Of Object) = GetTipeJenisBarang(idJenisBarang)
                If listTipe.Count > 0 Then
                    cmb_tipe_barang2.DataSource = listTipe
                    cmb_tipe_barang2.DisplayMember = "nama_tipe"
                    cmb_tipe_barang2.ValueMember = "id_tipe"
                Else
                    cmb_tipe_barang2.DataSource = New List(Of Object)
                End If
            End Try
    ...
    Private Sub cmb_tipe_barang2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_tipe_barang2.SelectedIndexChanged
        Try
            dt_barang_masuk.Rows.Clear()
            GetBarangMasukByStatusTipeAndJenis(1, cmb_jenis_barang2.SelectedValue, cmb_tipe_barang2.SelectedValue.id_tipe, UserInfo.IdToko)
        Catch ex As Exception
            dt_barang_masuk.Rows.Clear()
            GetBarangMasukByStatusTipeAndJenis(1, cmb_jenis_barang2.SelectedValue, cmb_tipe_barang2.SelectedValue, UserInfo.IdToko)
        End Try
    End Sub

    Private Sub cmb_client2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_client2.SelectedIndexChanged
        Try
            Dim client As Object = clients.Where(Function(x) x.id_client = cmb_client2.SelectedValue.id_client).FirstOrDefault()
            ...
            If client IsNot Nothing Then
                ...
                Me.txt_kota_ship.Text = client.kota_client
                Me.txt_kdpos_ship.Text = client.kdpos_client
                Me.txt_client_ship.Text = cmb_client2.SelectedValue.nama_client
                clientKodeSelect = client.kd_client.ToString
                Me.txt_pt.Text = companyName
            End If
        Catch ex As Exception
            Dim client As Object = clients.Where(Function(x) x.id_client = cmb_client2.SelectedValue).FirstOrDefault()
            If client IsNot Nothing Then
                Dim companyName As String
                Try
                    companyName = client.company_name
                ...
                Me.txt_kota_ship.Text = client.kota_client
                Me.txt_kdpos_ship.Text = client.kdpos_client
                Me.txt_client_ship.Text = cmb_client2.SelectedText
                clientKodeSelect = client.kd_client.ToString
                Me.txt_pt.Text = companyName
            End If
        End Try
    ...
    Private Sub dt_barang_masuk_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dt_barang_masuk.CellClick
        ...
        For Each selectedItem As DataGridViewRow In selectedIdBarangMasuk
            ...
            If barang IsNot Nothing Then
                ...
                listBarangMasukHandle2.Add(barang)
            End If
            'End If
    ...
    Private Sub btn_tambah2_Click(sender As Object, e As EventArgs) Handles btn_tambah2.Click
        Dim countBarangKeluarIsNow = listBarangKeluarFix.Count
        For Each barangMasukHandle As Object In listBarangMasukHandle2

            If (listBarangKeluarFix2.Count >= countBarangKeluarIsNow) Then
                MsgBox("Data Yang Telah Ditambah tidak sesuai dengan Jumlah barang yang akan di ganti!")
                Return
            End If

            If (listBarangMasukHandle2.Count > countBarangKeluarIsNow) Then
                MsgBox("Data Yang Telah Ditambah tidak sesuai dengan Jumlah barang yang akan di ganti!")
                Return
            End If
            ...
            If barangMasukHandle IsNot Nothing Then
                ...
                Dim checkValidationDataBarangKeluar As Object = listBarangKeluarFix2.Where(Function(x) x.id_barang_masuk = barangMasukHandle.id_barang_masuk).FirstOrDefault()

                If checkValidationDataBarangKeluar Is Nothing Then
                    dt_barang_keluar_fix2.Rows.Add(1)
                    Dim isTest As String
                    If barangMasukHandle.tested = 1 Then
                        isTest = "Teruji"
                    Else
                        isTest = "Tidak Teruji"
                    End If
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(0).Value = barangMasukHandle.nama_jenis
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(1).Value = barangMasukHandle.nama_tipe
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(2).Value = barangMasukHandle.serial_number
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(3).Value = barangMasukHandle.nama_kondisi
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(4).Value = isTest
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(5).Value = barangMasukHandle.nama_lokasi
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(6).Value = barangMasukHandle.detail_lokasi
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(7).Value = barangMasukHandle.catatan
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(8).Value = barangMasukHandle.nama_status
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(9).Value = barangMasukHandle.harga_jual
                    If triggerTambahBarangKeluar2 = False Then
                        triggerTambahBarangKeluar2 = True
                        dt_barang_keluar_fix2.Columns.Add("id_barang_masuk", "IdBarangMasuk")
                        dt_barang_keluar_fix2.Columns(13).Visible = False
                    End If
                    dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(13).Value = barangMasukHandle.id_barang_masuk

                    dt_barang_keluar_fix2.Update()
                    ...
                    listBarangKeluarFix2.Add(barangMasukHandle)
                        'index = index + 1
                    Else
                    MsgBox("Data Sudah Di Tambah!")
                End If
    ...
    Private Sub dt_barang_keluar_fix2_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dt_barang_keluar_fix2.CellContentClick

    End Sub

    Private Sub dt_barang_keluar_fix2_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dt_barang_keluar_fix2.CellClick
        listBarangKeluarFixHandle2.Clear()
        Dim selectedIdBarangKeluar = dt_barang_keluar_fix2.SelectedRows
        For Each selectedItem As DataGridViewRow In selectedIdBarangKeluar
            Dim idBarangMasuk = selectedItem.Cells(13).Value
            'Dim checkDuplicate As Object = listBarangKeluarFixHandle.Where(Function(x) x.id_barang_masuk = idBarangMasuk).FirstOrDefault()
            'If checkDuplicate Is Nothing Then
            Dim barang As Object = listBarangKeluarFix2.Where(Function(x) x.id_barang_masuk = idBarangMasuk).FirstOrDefault()
            listBarangKeluarFixHandle2.Add(barang)
            'End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim search As List(Of Object)
        If keywoard <> "" Then
            search = listBarangMasuk2.Where(Function(x) x.serial_number.ToString.Contains(keywoard)).ToList()
        Else
            search = listBarangMasuk2.ToList()
        End If
    ...
    Private Sub btn_hapus2_Click(sender As Object, e As EventArgs) Handles btn_hapus2.Click
        Me.txt_harga_total.Text = Double.Parse(0).ToString("N2")
        Me.txt_harga_akhir.Text = Double.Parse(0).ToString("N2")
        For Each item As Object In listBarangKeluarFixHandle2
            If item IsNot Nothing Then

                Dim deleteData As Object = listBarangKeluarFix2.Where(Function(x) x.id_barang_masuk = item.id_barang_masuk).FirstOrDefault()
                listBarangKeluarFix2.Remove(deleteData)
            End If
        Next
        dt_barang_keluar_fix2.Rows.Clear()

        For Each barangKeluarFix As Object In listBarangKeluarFix2
            ...
            Else
                isTest = "Tidak Teruji"
            End If
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(0).Value = barangKeluarFix.nama_jenis
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(1).Value = barangKeluarFix.nama_tipe
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(2).Value = barangKeluarFix.serial_number
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(3).Value = barangKeluarFix.nama_kondisi
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(4).Value = isTest
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(5).Value = barangKeluarFix.nama_lokasi
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(6).Value = barangKeluarFix.detail_lokasi
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(7).Value = barangKeluarFix.catatan
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(8).Value = barangKeluarFix.nama_status
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(9).Value = barangKeluarFix.harga_jual
            If triggerTambahBarangKeluar2 = False Then
                triggerTambahBarangKeluar2 = True
                dt_barang_keluar_fix2.Columns.Add("id_barang_masuk", "IdBarangMasuk")
                dt_barang_keluar_fix2.Columns(13).Visible = False
            End If
            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(13).Value = barangKeluarFix.id_barang_masuk
        ...
        Next
        If listBarangKeluarFix2.Count = 0 Then
            triggerTambahBarangKeluar2 = False
            dt_barang_keluar_fix2.Columns.RemoveAt(13)
        End If
    End Sub

    Private Sub btn_simpan_Click(sender As Object, e As EventArgs) Handles btn_simpan.Click
        Dim index = 0
        For Each insertDataBarangKeluar As Object In listBarangKeluarFix2
            Dim IdBarangLama = listBarangKeluarFix(index).id_barang
            Dim diskon = 0
            ...
            insertDataBarangKeluar.total_barang = listBarangKeluarFix2.Count
            ...
            insertDataBarangKeluar.id_barang_lama = IdBarangLama
    ...
    Private Sub dt_barang_keluar_fix2_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles dt_barang_keluar_fix2.CellValueChanged
        listBarangKeluarFixHandle2.Clear()

        Dim changeHargaJualBarangKeluar = dt_barang_keluar_fix2.SelectedCells
        ...
        For Each selectedItem As DataGridViewCell In changeHargaJualBarangKeluar
            If selectedItem.ColumnIndex = 9 Then
                If selectedItem.Value IsNot Nothing Then
                    If System.Text.RegularExpressions.Regex.IsMatch(selectedItem.Value, "[  ^ 0-9]") Then
                        listBarangKeluarFix2(selectedItem.RowIndex).harga_jual = Decimal.Parse(selectedItem.Value)
                        If index = 0 Then
                            dt_barang_keluar_fix2.Rows.Clear()
                        End If
                        Me.txt_harga_total.Text = 0
            ...
            ElseIf selectedItem.ColumnIndex = 10 Then
                If selectedItem.Value IsNot Nothing Then
                    If System.Text.RegularExpressions.Regex.IsMatch(selectedItem.Value, "[  ^ 0-9]") Then
                        listBarangKeluarFix2(selectedItem.RowIndex).garansi = selectedItem.Value

                        If listBarangKeluarFix2(selectedItem.RowIndex).garansi_type <> "" Then
                            If listBarangKeluarFix2(selectedItem.RowIndex).garansi_type = "Hari" Then
                                Dim tglkeluar As DateTime = Me.date_tgl_keluar.Value
                                Dim calculateGaransiExp As DateTime = tglkeluar.AddDays(listBarangKeluarFix2(selectedItem.RowIndex).garansi)
                                listBarangKeluarFix2(selectedItem.RowIndex).garansi_exp = calculateGaransiExp
                            ElseIf listBarangKeluarFix2(selectedItem.RowIndex).garansi_type = "Bulan" Then
                                Dim tglkeluar As DateTime = Me.date_tgl_keluar.Value
                                Dim calculateGaransiExp As DateTime = tglkeluar.AddMonths(listBarangKeluarFix2(selectedItem.RowIndex).garansi)
                                listBarangKeluarFix2(selectedItem.RowIndex).garansi_exp = calculateGaransiExp
                            ElseIf listBarangKeluarFix2(selectedItem.RowIndex).garansi_type = "Tahun" Then
                                Dim tglkeluar As DateTime = Me.date_tgl_keluar.Value
                                Dim calculateGaransiExp As DateTime = tglkeluar.AddYears(listBarangKeluarFix2(selectedItem.RowIndex).garansi)
                                listBarangKeluarFix2(selectedItem.RowIndex).garansi_exp = calculateGaransiExp
                            End If
                        End If
                        ...
                        For Each barangKeluarFix As Object In listBarangKeluarFix2
                            ...
                            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(8).Value = barangKeluarFix.nama_status
                            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(9).Value = barangKeluarFix.harga_jual
                            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(10).Value = barangKeluarFix.garansi
                            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(11).Value = barangKeluarFix.garansi_type
                            dt_barang_keluar_fix2.Rows(dt_barang_keluar_fix2.RowCount - 2).Cells(12).Value = barangKeluarFix.garansi_exp
            ...
            ElseIf selectedItem.ColumnIndex = 11 Then
                If selectedItem.Value IsNot Nothing Then
                    If selectedItem.Value <> "" Then
                        listBarangKeluarFix2(selectedItem.RowIndex).garansi_type = selectedItem.Value

                        If listBarangKeluarFix2(selectedItem.RowIndex).garansi IsNot Nothing Then
                            If listBarangKeluarFix2(selectedItem.RowIndex).garansi_type = "Hari" Then
                                Dim tglkeluar As DateTime = Me.date_tgl_keluar.Value
                                Dim calculateGaransiExp As DateTime = tglkeluar.AddDays(listBarangKeluarFix2(selectedItem.RowIndex).garansi)
                                listBarangKeluarFix2(selectedItem.RowIndex).garansi_exp = calculateGaransiExp
