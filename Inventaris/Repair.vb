...
Public Class Repair
    ...
    Function RandomString(r As Random) As String
        ...
        Return sb.ToString()
    End Function
    Private Sub Repair_Load(sender As Object, e As EventArgs)

    End Sub

    Private Sub Repair_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub dt_barang_masuk_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dt_barang_masuk.CellClick
        ...
        For Each selectedItem As DataGridViewRow In selectedIdBarangMasuk
            ...
            Dim idBarangMasuk = selectedItem.Cells(9).Value
            ...
            If barangMasukHandle IsNot Nothing Then
                ...
                If checkValidationDataBarangKeluar Is Nothing Then
                    ...
                    If triggerTambahBarangKeluar = False Then
                        ...
                        dt_barang_keluar_fix.Columns(9).Visible = False
                    End If
                    dt_barang_keluar_fix.Rows(dt_barang_keluar_fix.RowCount - 2).Cells(9).Value = barangMasukHandle.id_barang_masuk
    ...
    Private Sub btn_hapus_Click(sender As Object, e As EventArgs) Handles btn_hapus.Click
        ...
        For Each barangKeluarFix As Object In listBarangKeluarFix
            ...
            If triggerTambahBarangKeluar = False Then
                ...
                dt_barang_keluar_fix.Columns(9).Visible = False
            End If
            dt_barang_keluar_fix.Rows(dt_barang_keluar_fix.RowCount - 2).Cells(9).Value = barangKeluarFix.id_barang_masuk
        ...
        If listBarangKeluarFix.Count = 0 Then
            ...
            dt_barang_keluar_fix.Columns.RemoveAt(9)
        End If
    End Sub
    ...
    Private Sub btn_simpan_Click(sender As Object, e As EventArgs) Handles btn_simpan.Click
        ...
        For Each insertDataBarangKeluar As Object In listBarangKeluarFix
            ...
            insertDataBarangKeluar.id_status_barang = 2
