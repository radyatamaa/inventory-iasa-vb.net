    ...
    Sub LoadReport()
        ...
        Try
            ...
            For Each insertDataBarangMasuk As Object In listTransaksi
                ...
                row.Item(6) = insertDataBarangMasuk.tgl_keluar
                row.Item(7) = insertDataBarangMasuk.garansi
                row.Item(8) = insertDataBarangMasuk.garansi_type
                row.Item(9) = insertDataBarangMasuk.garansi_exp
                ...
                row.Item(16) = insertDataBarangMasuk.harga_jual
                row.Item(17) = insertDataBarangMasuk.jumlah
                row.Item(18) = insertDataBarangMasuk.id_status_barang
                row.Item(19) = insertDataBarangMasuk.nama_status
                row.Item(20) = insertDataBarangMasuk.created_by
                row.Item(21) = insertDataBarangMasuk.created_date
                row.Item(22) = insertDataBarangMasuk.company_name
                'row.Item(17) = "1"
