    ...
    Private Sub btncari2_Click(sender As Object, e As EventArgs) Handles btncari2.Click
        ...
        If TextBox1.Text <> "" Then
            ...
            ElseIf ComboBox1.Text = "Tested" Then
                search = search.Where(Function(x) x.tested.ToString.ToLower.Contains(keywoard.ToLower)).ToList()
            ...
            ElseIf ComboBox1.Text = "Location" Then
                search = search.Where(Function(x) x.nama_lokasi.ToString.ToLower.Contains(keywoard.ToLower)).ToList()
